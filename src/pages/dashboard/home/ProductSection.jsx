...
function ProductSection() {
  ...
  const [deleteProductsId, setDeleteProductsId] = useState(false);

  const dispatch = useDispatch();

  const handleClose = () => {
    setDeleteProductsId(false);
  };
  ...
  const handleDelete = () => {
    if (deleteProductsId) {
      ...
      deleteProduct();
      dispatch(deleteProducts(deleteProductsId));
      setDeleteProductsId(false);
    }
  };
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between mt-4">
                    ...
                    <button
                      onClick={() => setDeleteProductsId(product.id)}
